...
<head>
    ...
    <title>Security Policy - JobSure</title> 
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Highlight current page: Security Policy */
        .nav-links a[href="security_policy.php"] { color: var(--primary-dark); font-weight: 600; }
        ...
        .security-icons { display: flex; gap: 30px; justify-content: center; margin-top: 30px; flex-wrap: wrap; }
        .security-icons .icon-item { text-align: center; flex-basis: 150px; }
        .security-icons i { width: 40px; height: 40px; color: var(--primary-dark); margin-bottom: 10px; }
        .security-icons p { font-size: 14px; font-weight: 600; color: var(--text-dark); }
        ...
        .footer-links-list a[href*="security_policy.php"] { color: var(--primary-light); text-decoration: underline; font-weight: 600; }
        ...
        <section class="content-section">
            <div class="container">
                <div class="legal-content">
                    ...
                    <h2>1. Technical Measures</h2>
                    <p>We employ industry-standard security practices to protect your information:</p>
                    <ul>
                        <li>Encryption: All sensitive data, including passwords, are stored using strong, one-way cryptographic hashing. Data transmission between your browser and our servers is secured via SSL/TLS encryption.</li>
                        <li>Access Control: Access to sensitive production data is strictly limited to authorized personnel only on a need-to-know basis.</li>
                        <li>Monitoring: We use automated tools to monitor system activity for anomalies and potential security threats.</li>
                    </ul>

                    <h2>2. Your Security Responsibilities</h2>
                    <p>Your security is a partnership. We urge users to follow these practices:</p>
                    <ul>
                        <li>Strong Passwords: Use a unique, strong password and do not reuse it across multiple services.</li>
                        <li>Keep Data Current: Ensure your contact information is up-to-date so we can reach you regarding security notices.</li>
                        <li>Report Vulnerabilities: If you discover a potential vulnerability in our platform, please report it immediately to <a href="mailto:work.jobsure@gmail.com">work.jobsure@gmail.com</a>.</li>
                    </ul>

                    <h2>3. Data Handling and Retention</h2>
                    <p>We only retain your personal data for as long as necessary to provide you with the JobSure service, or as required by law. When data is no longer required, we take steps to securely delete or anonymize it.</p>
                </div>
            </div>
        </section>
    </main>
