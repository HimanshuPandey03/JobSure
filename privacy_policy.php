<?php
session_start();
// Assuming you don't need login/quiz check for legal pages
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Privacy Policy - JobSure</title> 
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Highlight current page: Privacy Policy */
        .nav-links a[href="privacy_policy.php"] { color: var(--primary-dark); font-weight: 600; }
        ...
        .legal-content { max-width: 850px; margin: 0 auto; padding: 30px; border: 1px solid var(--border-color); border-radius: 12px; box-shadow: var(--shadow); }
        .legal-content h2 { font-size: 24px; font-weight: 700; color: var(--primary-dark); margin-top: 30px; margin-bottom: 15px; border-bottom: 2px solid var(--border-color); padding-bottom: 5px; }
        .legal-content h3 { font-size: 18px; font-weight: 600; color: var(--text-dark); margin-top: 20px; margin-bottom: 10px; }
        .legal-content p, .legal-content li { font-size: 15px; color: var(--text-light); margin-bottom: 15px; }
        .legal-content ul { list-style: disc; padding-left: 25px; margin-bottom: 20px; }
        .update-date { font-size: 14px; color: var(--text-dark); font-weight: 500; margin-bottom: 30px; }
        ...
        .footer-links-list a[href*="privacy_policy.php"] { color: var(--primary-light); text-decoration: underline; font-weight: 600; }
        ...
        @media (max-width: 900px) {
            ...
            .legal-content { padding: 15px; margin: 0 10px; }
        }
    </style>
</head>
<body>
        ...
        <section class="content-section">
            <div class="container">
                <div class="legal-content">
                    ...
                    <p>We collect personal information that you voluntarily provide to us when you register on the Site, express an interest in obtaining information about us or our products and services, when you participate in activities on the Site, or otherwise contact us. This includes:</p>
                    <ul>
                        <li>Identity Data: Name, email address, phone number.</li>
                        <li>Profile Data: Resume/CV, work history, skills, educational background, and salary expectations.</li>
                        <li>Assessment Data: Answers and scores from the mandatory assessment quiz.</li>
                    </ul>
                    ...
                    <ul>
                        ...
                        <li>Connect you with relevant job and internship opportunities.</li>
                        <li>Process job applications and assessment results.</li>
                        <li>Improve, optimize, and personalize your experience on the Site.</li>
                        <li>Communicate with you regarding service updates or security alerts.</li>
                    </ul>

                    <h2>3. Disclosure of Your Information</h2>
                    <p>We may share information we have collected in certain situations:</p>
                    <ul>
                        <li>With Employers/Clients: We share your Profile Data (including your resume and quiz results) with prospective employers when you apply for a job or when your profile matches their hiring criteria.</li>
                        <li>Legal Requirements: If required by law or in response to valid requests by public authorities (e.g., a court order or government agency).</li>
                        <li>Service Providers: With third-party vendors, consultants, and other service providers who perform services for us or on our behalf (e.g., hosting, data analysis).</li>
                    </ul>

                    <h2>4. Security of Your Information</h2>
                    <p>We use reasonable administrative, technical, and physical security measures to help protect your personal information. While we have taken reasonable steps to secure the personal information you provide to us, please be aware that no security measures are perfect or impenetrable, and no method of data transmission can be guaranteed against any interception or other type of misuse.</p>

                    <h2>5. Your Rights</h2>
                    <p>Depending on your location, you may have the right to request access to, update, or delete your personal data. You can usually manage your profile settings directly through the Site or contact us at <a href="mailto:work.jobsure@gmail.com">work.jobsure@gmail.com</a> to exercise these rights.</p>
                </div>
            </div>
        </section>
    </main>
