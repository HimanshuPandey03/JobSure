...
<head>
    ...
    <title>Terms of Service - JobSure</title> 
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Highlight current page: Terms of Service */
        .nav-links a[href="terms_of_service.php"] { color: var(--primary-dark); font-weight: 600; }
        ...
        .footer-links-list a[href*="terms_of_service.php"] { color: var(--primary-light); text-decoration: underline; font-weight: 600; }
        ...
        <section class="content-section">
            <div class="container">
                <div class="legal-content">
                    ...
                    <p>By using the JobSure platform (the "Site"), you confirm that you are over the age of 18 or accessing the site with parental consent, and you accept these Terms in full. If you disagree with any part of these Terms, you must not use the Site.</p>

                    <h2>2. User Accounts and Eligibility</h2>
                    <ul>
                        <li>Account Creation: You must provide accurate and complete information during registration. You are solely responsible for maintaining the confidentiality of your account password.</li>
                        <li>Eligibility: The service is intended for individuals seeking employment or internships and employers seeking candidates.</li>
                        <li>Assessment: Access to job/internship listings is contingent upon successful completion of the mandatory skills assessment.</li>
                    </ul>

                    <h2>3. User Conduct and Content</h2>
                    <h3>Prohibited Actions:</h3>
                    <p>You agree not to post, submit, or transmit any content that is:</p>
                    <ul>
                        <li>Illegal, misleading, fraudulent, or harassing.</li>
                        <li>Non-original or copyright-infringing (e.g., resumes not belonging to you).</li>
                        <li>Spam, unsolicited advertising, or pyramid schemes.</li>
                        <li>Containing software viruses or any other computer code designed to interrupt or destroy the functionality of any computer software or hardware.</li>
                    </ul>

                    <h2>4. JobSure's Role</h2>
                    <p>JobSure acts as a venue for job seekers and employers. We do not screen jobs or candidates and are not involved in the actual transaction between employers and candidates. We make no warranty as to the quality, accuracy, or legality of the jobs or the resumes posted.</p>
